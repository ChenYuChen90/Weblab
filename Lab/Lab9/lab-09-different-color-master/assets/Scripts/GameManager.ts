...
export default class GameManager extends cc.Component {
    ...
    spawnCircle(row: number){
        ...
        var answer = Math.floor(Math.random() * ((row ** 2)-1));
        ...
        for(var i = 0; i < row**2; i++){
            ...
            let btn_act = new cc.Component.EventHandler();
            ...
            if(i == answer){
                ...
                circles.on(cc.Node.EventType.MOUSE_DOWN, (event) => {
